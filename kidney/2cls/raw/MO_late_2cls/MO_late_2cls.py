...
miRNApath = "./kidney_2cls_mRNA_rf.csv"
...
# train data X
X = pd.concat([data_mRNA.iloc[:, :-1], data_miRNA.iloc[:, :-1]], axis=1).values
# label Y
Y = data_mRNA.label.values.reshape(-1, 1)
...
metrics_table.to_csv("MO_late_2cls_metrics_result.csv")
